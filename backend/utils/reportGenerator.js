...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            ${scan.results && scan.results.msfAnalysis ? `
            <div class="nmap-output" style="border-left: 4px solid #9c27b0;">
                <div class="nmap-title" style="color: #9c27b0;">Metasploit Vulnerability Analysis</div>
                ${escapeHtml(scan.results.msfAnalysis)}
            </div>
            ` : ''}

            ${scan.results && scan.results.msfExploit ? `
            <div class="nmap-output" style="border-left: 4px solid #ff9800;">
                <div class="nmap-title" style="color: #ff9800;">Exploit Suggestions</div>
                ${escapeHtml(scan.results.msfExploit)}
            </div>
            ` : ''}

            ${scan.results && scan.results.riskLevel ? `
            <div class="info-box" style="border-left: 4px solid #e91e63;">
                <label>Risk Level</label>
                <div class="value" style="font-size: 1.3em; font-weight: bold;">${escapeHtml(scan.results.riskLevel)}</div>
            </div>
            ` : ''}

            ${scan.results && scan.results.summary ? `
            <div class="nmap-output" style="border-left: 4px solid #4caf50;">
                <div class="nmap-title" style="color: #4caf50;">Summary</div>
                ${escapeHtml(scan.results.summary)}
            </div>
            ` : ''}
        </div>
        <footer>
